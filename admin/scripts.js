...
jQuery(document).ready(function(){
	...
	$('#tartalom_lyrics').load('content/lyrics/erzelmek_nelkul.html');
	
	$('.szamcim').click(function(){
		
		var page_name = $(this).attr('content/lyrics/page_name');
		
		$('#tartalom_lyrics').load(page_name);	 
	});
});
